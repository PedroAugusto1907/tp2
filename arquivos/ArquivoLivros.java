...
public class ArquivoLivros extends Arquivo<Livro> {
  ...
  public ArquivoLivros() throws Exception {
    ...
    listaInvertidaTitulos = new ListaInvertida(4, "dados/dicionario.listainv.db", "dados/blocos.listainv.db");
  ...
  public List<Livro> buscarLivrosPorTermos(String termos) throws Exception {
    ...
    for (String termo : termosDividivos) {
      var termoNormalizado = Normalizer.normalize(termo, Normalizer.Form.NFD).replaceAll("[^\\p{ASCII}]", "").toLowerCase();
